...
![A sample caption. Image source:
unknown.](_assets/data-representation1.png "A sample title."){fig-alt="Sample alt text. To be replaced!"}
...
![A sample caption. Image source:
unknown.](_assets/data-representation2.png "A sample title."){fig-alt="Sample alt text. To be replaced!"}
...
![A sample caption. Image source:
unknown.](_assets/data-representation4.png "A sample title."){fig-alt="Sample alt text. To be replaced!"}
