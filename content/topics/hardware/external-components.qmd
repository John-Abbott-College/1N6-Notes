...
**HDMI** is the new standard for audio and video transmission in a single cable. Digital signal only.

**DisplayPort** (and Mini DisplayPort) more commonly used in desktop computers. Digital signal only.
...
2.	Which statement is INCORRECT about Plasma screens:
a.	It contains ionized gas that lights up when stimulated by electricity. 
b.	It doesn’t work well at high altitudes.
c.	It’s power efficient.
d.	It has a wide range of colors.
...
5. Which of the following display technologies are most susceptable to sreen burn-in. Select all possible answers. Select all that applies.
a. CRT
b. Plasma
c. LCD
d. LCD with LED backlight
...
6. Which of the following displays allow for the msot vivid images. Select all that applies.
a. CRT
b. Plasma
c. LCD
d. LCD with LED backlight
...
7. Which of the following displays have the best viweing angles?
a. CRT
b. Plasma
c. LCD
d. LCD with LED backlight
