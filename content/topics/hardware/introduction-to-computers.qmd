...
![**Abacus**. Image by Pearson Scott Foresman, Public domain, via Wikimedia Commons][abacus]
...
![**Difference engine** diagram, via Wikimedia Commons][diff-engine-diag]

![**Difference engine** built in 2002, via Wikimedia Commons][diff-engine-real]
:::
