...
## Hardware vs Software
 ...
 __Hardware__: The  __physical__  components that make up a computer system\.

![](_assets/Lecture%202%20-%20Peripheral%20Devices0.jpg)

__Software__: The  __programs__  \(instructions\) that tell the computer \(the hardware\) what to do\.
