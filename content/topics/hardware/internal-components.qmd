...
5. [Processor (CPU)](#cpu)
6. [Cooling Devices](#cooling-devices)
7. [Memory (RAM)](#main-memory-ram)
8. [Graphics processor (GPU)](#graphics-cards-gpu)
...
![Land Grid Array – LGA](_assets/internal-components-cpu-lda.png)

![Pin Grid Array – PGA](_assets/internal-components-cpu-pga.png)
